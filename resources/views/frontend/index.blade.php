        ...
        <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item {{(($key==0)? 'active' : '')}}">
                    ...
                    <div class="carousel-caption d-none d-md-block text-left">
                        ...
                        <a class="btn btn-lg ws-btn wow fadeInUpBig" href="{{route('product-grids')}}" role="button">Sản phẩm<i class="far fa-arrow-alt-circle-right"></i></i></a>
                    </div>
                </div>
            @endforeach
        </div>
                                    ...
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="{{route('product-detail',$product->slug)}}">
                                                ...
                                                @if($product->stock<=0)
                                                    <span class="out-of-stock">Hết</span>
...
{{--                                <a href="{{route('product-detail',$data->slug)}}">Sản phẩm</a>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <!-- /End Single Banner  -->--}}
