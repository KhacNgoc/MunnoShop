      ...
      <div class="table-responsive">
        ...
        <span style="float:right">
            <div class="col-md-12 justify-content-between align-items-center d-flex mt-5">
                <a href="{{$postTags->previousPageUrl()}}">
                    <i class="fa fa-chevron-left" aria-hidden="true"></i>
                </a>
                @for($i=1;$i<=$postTags->lastPage();$i++)
                    <a style="background: #ebcda8;width: 25px;text-align: center;border-radius: 50%;" href="{{$postTags->url($i)}}">{{$i}}</a>
                @endfor
                <a href="{{$postTags->nextPageUrl()}}">
